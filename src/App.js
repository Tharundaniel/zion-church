  ...
  return (
    <div style={{ fontFamily: "'Palatino Linotype', Georgia, serif", background: W, color: "#1a0030", overflowX: "hidden" }}>
      <style>{`
        ...
        :root { --p:${P}; --pl:${PL}; --pm:${PM}; --g:${G}; --gl:${GL}; }
        * { box-sizing: border-box; margin:0; padding:0; }
        ...
        @keyframes pulse { 0%,100%{box-shadow:0 0 0 0 ${G}55}50%{box-shadow:0 0 0 12px transparent} }
        ...
        .fi { animation: fadeIn .6s ease forwards; opacity:0; }
        .float { animation: float 4s ease-in-out infinite; }
        .pulse { animation: pulse 2s ease infinite; }
        .shimmer { animation: shimmer 2.5s ease-in-out infinite; }
        .card:hover { transform:translateY(-5px)!important; }
        .navbtn:hover { color:${GL}!important; }
        .ghostbtn:hover { background:${G}22!important; }
        input:focus, textarea:focus { outline:none; border-color:${PM}!important; box-shadow:0 0 0 3px ${PM}22!important; }
        @media(max-width:768px){
          ...
          .three-col{grid-template-columns:1fr!important;gap:1.25rem!important}
          ...
          .stat-row{flex-wrap:wrap!important;gap:1.5rem!important}
          .give-amounts{grid-template-columns:1fr 1fr!important}
